...
* **Người sáng lập ý tưởng:** Duy Luân Dễ Thương
...
Công cụ sẽ tạo báo cáo ngắn gồm **thời điểm test, model máy, dung lượng pin theo specs, dung lượng thực tế, độ chai và thời lượng session theo phút**, rồi lưu vào **`battery_report.txt`**. Cuối báo cáo có hàng tab để copy-paste thẳng vào database hoặc Google Sheets.
...
| `low_battery_popup.enabled` | Tự đóng popup pin yếu trên Windows bằng phím Enter |
| `low_battery_popup.threshold_percent` | Bắt đầu theo dõi popup khi pin bằng hoặc thấp hơn mức này |
